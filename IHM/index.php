  ...
  <div class="row justify-content-center g-4">
    ...
    <div class="col-md-5" data-aos="fade-up" data-aos-delay="400">
      <div class="card shadow text-center h-100">
        <div class="card-body d-flex flex-column">
          <div class="icon-wrapper mb-4">
            <i class="fas fa-user-tie display-4" style="color: #509cac;"></i>
          </div>
          <h4 class="card-title mb-3">Espace Agent</h4>
          <p class="card-text flex-grow-1">
            Déposez le fichier annuel des consommations clients après la tournée de relevé.
          </p>
          <a href="IHM/agent/login.php" class="btn mt-3" style="background-color: #509cac; color: white;">
            <i class="fas fa-sign-in-alt me-2"></i>Se connecter
          </a>
        </div>
      </div>
