...
<html lang="fr">
    <head>
        ...
        <title>Connexion - Espace Agent</title>
        <!-- Bootstrap CSS -->
    ...
    <body>
        ...
        <div class="auth-card" data-aos="fade-up">
            ...
            <h2 class="card-title text-center mb-4">Connexion Agent</h2>
            ...
            <form action="../../traitement/agentTraitement.php" method="POST">
                <input type="hidden" name="action" value="login">
                
                <div class="mb-3">
                    <label for="emailAgent" class="form-label">
                    <i class="fas fa-envelope me-2"></i>Email Agent
                    </label>
                    <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                    <input type="email" class="form-control" name="emailAgent" id="emailAgent" required>
                    </div>
                </div>
                
                <div class="mb-4">
                    <label for="passwordAgent" class="form-label">
                    <i class="fas fa-lock me-2"></i>Mot de passe
                    </label>
                    <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-lock"></i></span>
                    <input type="password" class="form-control" name="passwordAgent" id="passwordAgent" required>
        ...
        <script>
            ...
            // Change 'password' to 'passwordAgent' to match your input ID
            const passwordInput = document.getElementById('passwordAgent');
