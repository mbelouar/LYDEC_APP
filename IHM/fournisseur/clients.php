<?php
include_once "../../traitement/fournisseurClientT.php";
?>
<!DOCTYPE html>
<html lang="fr">
<head>
        ...
        <form method="post" action="../../traitement/clientTraitement.php">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="numero_de_compteur" class="form-control" required>
            </div>
            <div class="col-md-6">
      ...
      <div class="card-body">
        <form method="post" action="../../traitement/clientTraitement.php">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <label class="form-label">Numéro de compteur</label>
              <input type="text" name="numero_de_compteur" class="form-control" 
                    value="<?php echo htmlspecialchars($editingClient['numero_de_compteur'] ?? ''); ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label">Adresse</label>
